...
contract DeployPhase4And5 is Script {
    ...
    address constant COLLATERAL_MANAGER =
        0x2BA6Be87c33acec211B16163997f66aecf73F467;
    address constant PRICE_ORACLE = 0x746DE549Dea06A7871B4FBA32309DBA01D0A98bc;
    address constant INTEREST_RATE_MODEL =
        0x4924f29EDBa2B85dC098E67c1762696456a8b94A;
    ...
    function run() external {
        ...
        BadDebtSocialisation bds = new BadDebtSocialisation(
            deployer,
            LENDING_POOL
        );
        ...
        // 4.3 LoopStrategy
        LoopStrategy loop = new LoopStrategy(
            deployer,
            LENDING_POOL,
            LENDING_POOL
        );
        ...
        // 4.4 RiskGovernance
        RiskGovernance riskGov = new RiskGovernance(
            deployer,
            COLLATERAL_MANAGER,
            USDC
        );
