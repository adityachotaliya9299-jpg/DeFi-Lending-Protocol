...
contract SetupAssets is Script {
    ...
    function run() external {
        ...
        console2.log(
            "=== Setting up 3 assets on Sepolia (chain",
            block.chainid,
            ") ==="
        );
        ...
        console2.log(
            "NEXT_PUBLIC_LWETH=",
            pool.getReserveData(WETH).lTokenAddress
        );
        console2.log(
            "NEXT_PUBLIC_LUSDC=",
            pool.getReserveData(USDC).lTokenAddress
        );
        console2.log(
            "NEXT_PUBLIC_LLINK=",
            pool.getReserveData(LINK).lTokenAddress
        );
        console2.log("");
    }
}
