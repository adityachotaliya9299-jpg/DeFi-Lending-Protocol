...
contract MultiUserTest is Test {
    ...
    function test_multiBorrow_independentDebtTracking() public {
        ...
        assertApproxEqAbs(
            pool.getUserDebt(alice, address(usdc)),
            10_000e6,
            100
        );
    ...
    function test_multiBorrow_repaymentDoesNotAffectOthers() public {
        ...
        assertApproxEqAbs(
            pool.getUserDebt(bob, address(usdc)),
            bobDebtBefore,
            1e6
        );
    }
    ...
    function test_treasury_accumulatesReservesOverTime() public {
        ...
        assertGt(
            treasuryAfter,
            treasuryBefore,
            "treasury must accumulate on repayment"
        );
    ...
    function test_liquidation_doesNotAffectOtherUsersDeposits() public {
        ...
        assertApproxEqAbs(
            pool.getUserDeposit(eve, address(usdc)),
            eveBalBefore,
            1e6
        );
    }
